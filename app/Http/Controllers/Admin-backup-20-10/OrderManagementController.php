...
class OrderManagementController extends Controller
{
	...
	{	
		...
		{
			$action_button = '<ul class="icons-list">
			...
			foreach ($build_result->data as $key => $data) 
			{
				...
				$action_button_html .= '<li> <a  title="" href="'.$view_link_url.'" data-original-title="View" data-id="'.$data->id.'" id="open_edit_staff_modal"><i class="fa fa-download" title="Download"></i></a></li>';

				if(isset($data->get_shipment_details) && !empty($data->get_shipment_details) ){

					$action_button_html .= '<li> <a  title="" href="'.$data->get_shipment_details->LabelURL.'" target="_blank"><i class="fa fa-barcode" title="Barcode"></i></a></li>';
				}
				...
				$delivery_status_anchor = $delivery_status.' <a  data-original-title="View" data-id="'.$data->id.'" id="open_delivery_status_modal"><i class="fa fa-cog" title="View">View</i></a>';
				$delivery_type 			= isset($data->get_delivery_type->delivery_type)? $data->get_delivery_type->delivery_type :'';
			...
			$action_button_html = '
				...
				$build_result->data[$key]->printing_status      = $printing_status;
				...
				$build_result->data[$key]->evaluation        	= "Not Rated";
