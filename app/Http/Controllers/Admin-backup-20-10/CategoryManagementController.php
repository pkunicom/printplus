	...
	{	
		...
		if(isset($build_result->data) && sizeof($build_result->data)>0)
		{
			foreach ($build_result->data as $key => $data) 
			{
				...
				{
					$build_status_btn = '<a  href="'.$this->module_url_path.'/unblock/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to activate this Category ?\')"><i class="fa fa-eye" title="Blocked"></i></a>&nbsp&nbsp&nbsp ';
				}
				elseif($data->status != null && $data->status == "1")
				{
					$build_status_btn = '<a  href="'.$this->module_url_path.'/block/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to inactivate this Category ?\')"><i class="fa fa-eye-slash" title="Active"></i></a> &nbsp&nbsp&nbsp';
				}
				$build_edit_button 		= '<a  title="" href="javascript:void(0)"  data-id="'.$data->id.'"  id="open_edit_category_modal"><i class="fa fa-pencil" title="Edit"> Edit Category</i></a>&nbsp&nbsp&nbsp';
				
				$build_sub_cat_button 	= '<a  href="'.$this->module_url_path.'/subcategory/'.base64_encode($data->id).'" ><i class="fa fa-cog" title="Manage Sub-Category"> Manage Sub-Category</i></a> ';
                ...
                $action_setting_button_html .= '<li style="height: 35px;">'.$build_sub_cat_button.'</li>';
				$action_setting_button_html .= '</ul>&nbsp&nbsp&nbsp';
				$action_setting_button_html .= $build_status_btn;
				$action_setting_button_html .= '<a href='.$built_delete_href.'  title="delete" onclick="return confirm_action(this,event,\'Do you really want to delete this Category ?\')"><i class="fa fa-trash"></i></a>';
		...
		if(isset($build_result->data) && sizeof($build_result->data)>0)
		{
			foreach ($build_result->data as $key => $data) 
			{
				...
				if($data->status != null && $data->status == "0")
				{
					...
					onclick="return confirm_action(this,event,\'Do you really want to activate this Sub-Category ?\')" ><i class="fa fa-eye" title="Blocked"></i></a>&nbsp&nbsp&nbsp ';
				}
				elseif($data->status != null && $data->status == "1")
				{
					$build_status_btn = '<a  href="'.$this->module_url_path.'/block_sub_cat/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to inactivate this Sub-Category ?\')" ><i class="fa fa-eye-slash" title="Active"></i></a> &nbsp&nbsp&nbsp';
				}
				$build_edit_button 		= '<a  title="" href="javascript:void(0)"  data-id="'.$data->id.'"  id="open_edit_sub_category_modal"><i class="fa fa-cog" title="Edit"></i></a>&nbsp&nbsp&nbsp';
				// $action_button_html .= '<a  title="" href="javascript:void(0)"  data-id="'.$data->id.'"  id="open_view_category_modal"><i class="fa fa-eye" title="View"></i></a>  ';
				$action_button_html 	 = $build_edit_button;
				$action_button_html 	 .= $build_status_btn;
				$action_button_html 	 .= '<a href='.$built_delete_href.' title="Delete"  onclick="return confirm_action(this,event,\'Do you really want to delete this Sub-Category ?\')" ><i class="fa fa-trash"></i></a>';
				$english_name 			= isset($data->english_name)? $data->english_name :'';
				$arabic_name 			= isset($data->arabic_name)? $data->arabic_name :'';
				$id 	    			= isset($data->id)? base64_encode($data->id):'';
				$status 				= isset($data->status)? $data->status :'-';
