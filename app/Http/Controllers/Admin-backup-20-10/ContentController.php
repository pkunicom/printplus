	...
	{	
		...
		if(isset($build_result->data) && sizeof($build_result->data)>0)
		{
			foreach ($build_result->data as $key => $data) 
			{
				...
				$action_button_html = '<a  title="" href="'.$edit_link_url.'" data-original-title="Edit" ><i class="fa fa-cog" title="Edit"></i></a> <a  title="" href="'.$delete_link_url.'" data-original-title="Delete" data-id="'.$data->id.'" onclick="return confirm_action(this,event,\'Do you really want to delete this Content ?\')" ><i class="fa fa-trash" title="Delete"></i></a>';
