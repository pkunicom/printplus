	...
	{	
		...
		if(isset($build_result->data) && sizeof($build_result->data)>0)
		{
			foreach ($build_result->data as $key => $data) 
			{
				...
				$action_button_html = '<a  title="" href="javascript:void(0)" data-original-title="Pay" data-id="'.$data->id.'" id="open_edit_modal_form_vertical" ><i class="fa fa-cog" title="Edit"></i></a> <a href='.$built_delete_href.'  title="delete" onclick="return confirm_action(this,event,\'Do you really want to delete this Pickup Point ?\')"><i class="fa fa-trash"></i></a>';
