...
class InvoiceController extends Controller
{
    ...
    function __construct(MailService $mail_service)
    {
		...
		$this->module_view_folder           = "agent.invoice";
    ...
    // invoices listing : AUTHOR (Harsh Chauhan)
	...
	{	
		...
		$obj_request_data = $this->BaseModel->with('get_agent_details')->where('agent_id',$user_id)->orderBy('created_at','DESC');
	...
	// ajax call to get invoices data: AUTHOR (Harsh Chauhan)
    ...
    // ajax call to change status : AUTHOR (Harsh Chauhan)
	...
	// pay invoices: AUTHOR (Harsh Chauhan)
    ...
    {   
        ...
        $obj_invoices = $this->BaseModel->with('get_agent_details')->where('agent_id',$user_id)
										   ->get();
        if($obj_invoices)
        { 
