...

		{
...

			{
...

				{
					...
					$build_status_btn = '<a  href="'.$this->module_url_path.'/unblock/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to Live this Option ?\')"><i class="icon-eye-blocked" title="Live"></i>Live</a>';
					$build_edit_button 		= '';

					$build_sub_option_button 	= '';
...

				{
					...
					$build_status_btn = '<a  href="'.$this->module_url_path.'/block/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to Hide this Option ?\')"><i class="icon-eye" title="Hidden"></i>Hidden</a>';
					$build_edit_button 		= '<a  title="" href="javascript:void(0)"  data-id="'.$data->id.'"  id="open_edit_option_modal"><i class="icon-pencil" title="Edit"> </i>Edit option</a>';

					$build_sub_option_button 	= '<a  href="'.$this->module_url_path.'/suboption/'.base64_encode($data->id).'" ><i class="icon-cog" title="Manage Sub-Option"> </i>Manage Sub-Option</a> ';
                ...
                $action_button_html .= '<li>'.$build_sub_option_button.'</li>';

				// $action_setting_button_html .= '</ul>&nbsp&nbsp&nbsp';

				$action_button_html .= '<li>'.$build_status_btn.'</li>';

				$action_button_html .= '<li><a href='.$built_delete_href.'  title="delete" onclick="return confirm_action(this,event,\'Do you really want to delete this Option ?\')"><i class="icon-trash"></i>Delete</a></li>';
...

		{
			...
			$action_button_html = '<ul class="icons-list">
...

				{
					...
					onclick="return confirm_action(this,event,\'Do you really want to activate this Sub-Option ?\')" ><i class="fa fa-eye-slash" title="Blocked"></i>Blocked</a>';
...

				{
					...
					$build_status_btn = '<a  href="'.$this->module_url_path.'/block_sub_option/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to inactivate this Sub-Option ?\')" ><i class="fa fa-eye" title="Active"></i>Active</a>';

				}

				$build_edit_button 			= '<a  title="" href="javascript:void(0)"  data-id="'.$data->id.'"  id="open_edit_sub_option_modal"><i class="fa fa-cog" title="Edit"></i>Edit</a>';
				...
				$action_button_html 	   .= '<li><a href='.$built_delete_href.' title="Delete"  onclick="return confirm_action(this,event,\'Do you really want to delete this Sub-Option ?\')" ><i class="fa fa-trash"></i>Delete</a></li>';
