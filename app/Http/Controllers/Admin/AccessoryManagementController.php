	...
	{	
		...
		$action_button_html = '<ul class="icons-list">
...

				{
					...
					$build_status_btn = '<a  href="'.$this->module_url_path.'/unblock/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to Live this Accessory ?\')"><i class="icon-eye" title="Live"></i>Live</a>&nbsp&nbsp&nbsp ';
					$build_edit_button 		= '';
					$bulit_delete_button 	='';
				}
...

				{
					...
					$build_status_btn = '<a  href="'.$this->module_url_path.'/block/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to Hidden this Accessory ?\')"><i class="icon-eye-blocked" title="Hidden"></i>Hidden</a> &nbsp&nbsp&nbsp';
					
					$build_edit_button 		= '<a  title="" href="javascript:void(0)"  data-id="'.$data->id.'"  id="open_edit_accessory_modal"><i class="icon-cog" title="Edit"></i>Edit</a>&nbsp&nbsp&nbsp';

					$bulit_delete_button 	=' <a href='.$built_delete_href.'  title="delete" onclick="return confirm_action(this,event,\'Do you really want to delete this Accessory ?\')"><i class="icon-trash"></i>Delete</a>';
				...
				$action_button_html .= '<li> '.$bulit_delete_button.'</li>';
