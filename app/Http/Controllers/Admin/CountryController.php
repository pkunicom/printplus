	...
	{	
...

		{
...

			{
				...
				$action_button_html .= '<li><a  title="" href="'.$view_link_url.'" data-original-title="View" data-id="'.$data->id.'" id="open_edit_modal"><i class="icon-pencil7" title="Edit"></i>Edit</a></li> ';
...

				{
					...
					$action_button_html .= '<li><a  href="'.$this->module_url_path.'/unblock/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to activate this Country ?\')"><i class="icon-blocked" title="Blocked"></i>Blocked</a></li>&nbsp&nbsp&nbsp ';
...

				{
					...
					$action_button_html .= '<li><a  href="'.$this->module_url_path.'/block/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to inactivate this Country ?\')"><i class="icon-eye" title="Active"></i>Active</a></li> &nbsp&nbsp&nbsp';
