...

		{
...

			{
...

				{
					...
					$action_button_html .= '<li><a  href="'.$this->module_url_path.'/unblock/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to activate this City ?\')"><i class="icon-blocked" title="Blocked"></i>Blocked</a></li>&nbsp&nbsp&nbsp ';
...

				{
					...
					$action_button_html .= '<li><a  href="'.$this->module_url_path.'/block/'.base64_encode($data->id).'" onclick="return confirm_action(this,event,\'Do you really want to inactivate this City ?\')"><i class="icon-eye" title="Active"></i>Active</a></li> &nbsp&nbsp&nbsp';
