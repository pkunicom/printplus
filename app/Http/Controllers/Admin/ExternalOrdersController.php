	...
	{	
...

		{
...

			{
				...
				$action_button_html .= '<li><a  title="" href="'.$view_link_url.'" data-original-title="View" data-id="'.$data->id.'" id="open_edit_modal"><i class="icon-pencil7" title="Edit"></i>Edit</a></li><li> <a href='.$built_delete_href.'  title="delete" onclick="return confirm_action(this,event,\'Do you really want to delete this Order ?\')"><i class="icon-trash"></i>Delete</a></li>';
