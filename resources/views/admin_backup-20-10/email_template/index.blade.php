	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<!--	<a class="btn btn-primary"  id="add_new_page" href="{{ $module_url_path }}/add_email_template">Add Template</a>-->
				<!--</div>-->
...
$(function() {
    ...
    var table = $('.datatable-column-search-inputs').DataTable({
        ...
        columns: [
            ...
            {data : 'template_name',"orderable":true,"searchable":true,name:'template_name'},
