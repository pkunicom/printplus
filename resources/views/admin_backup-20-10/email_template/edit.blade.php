				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-body">
							...
							<form action="{{$module_url_path}}/update_email_template/{{ base64_encode($arr_data['id']) }}" id="frm_front_page" name="frm_front_page" class="form-horizontal cmxform" method="post" enctype="multipart/form-data">
							{{csrf_field()}}
								<fieldset class="content-group">
									<legend class="text-bold">Edit Template</legend>

									<div class="form-group">
										<label class="control-label col-lg-2">Template Name</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="template_name" id="template_name" data-rule-required="true" value="{{ $arr_data['template_name'] ?? '' }}">
										</div>
									</div>

									<div class="form-group">
										<label class="control-label col-lg-2"> Template From</label>
										<div class="col-lg-10">
											<input type="text" class="form-control"  name="template_from" id="template_from" data-rule-required="true" value="{{ $arr_data['template_from'] ?? '' }}">
										</div>
									</div>

									<div class="form-group">
										<label class="control-label col-lg-2">Template From Email</label>
										<div class="col-lg-10">
											<input type="text" class="form-control"  name="template_from_mail" id="template_from_mail" data-rule-required="true" value="{{ $arr_data['template_from_mail'] ?? '' }}">
										</div>
									</div>

									<div class="form-group">
										<label class="control-label col-lg-2">Template Subject</label>
										<div class="col-lg-10">
											<input type="text" class="form-control"  name="template_subject" id="template_subject" data-rule-required="true" value="{{ $arr_data['template_subject'] ?? '' }}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea rows="5" cols="5" class="form-control"  name="template_html" id="template_html" data-rule-required="true">{{ $arr_data['template_html'] ?? '' }} </textarea>
										</div>
									</div>
									
										@if(isset($arr_variables) && sizeof($arr_variables)>0 && !empty($arr_variables))
										<br>
										<div class="note"><b>Note : </b>Please don't change the #### variables in the email template body.</div>
										<!--<br>-->
										<!--<span> Variables: </span>-->
