...
<div class="sidebar sidebar-main">
	<div class="logo-section">
		<a class="navbar-brand sidebar-login-logo" href="{{ url('/') }}/admin"><img src="{{ asset('assets/admin') }}/assets/images/logo_light.png" alt=""></a>
	</div>
		...
		<div class="sidebar-category sidebar-category-visible">
			<div class="category-content no-padding">
				<ul class="navigation navigation-main navigation-accordion">
					...
					<li class="@if((Request::segment(2) == 'staff')|| (Request::segment(2) == 'agent')||(Request::segment(2) == 'customer') ) active @endif">
						<a href="#"><i class="icon-user"></i> <span>User</span></a>
						<ul>
							<li class="@if(Request::segment(2) == 'staff') active @endif"><a href="{{ url('/') }}/admin/staff">Staff Managment</a></li>
							<li class="@if(Request::segment(2) == 'agent') active @endif"><a href="{{ url('/') }}/admin/agent">Agent Managment</a></li>
							<li class="@if(Request::segment(2) == 'customers') active @endif"><a href="{{ url('/') }}/admin/customers">Customer Managment</a></li>
							
						</ul>
					</li>
					<li  class="@if(Request::segment(2) == 'category') active @endif">
						<a href="#"><i class="icon-copy"></i> <span>Products</span></a>
						<ul>
							<li class="@if(Request::segment(2) == 'category') active @endif"><a href="{{ url('/') }}/admin/category">Category Managment</a></li>
							<li class="@if(Request::segment(2) == 'option') active @endif"><a href="{{ url('/') }}/admin/option">Option Managment</a></li>
							<li class="@if(Request::segment(2) == 'accessory') active @endif"><a href="{{ url('/') }}/admin/accessory">Accessory Managment</a></li>
							<li class="@if(Request::segment(2) == 'product') active @endif"><a href="{{ url('/') }}/admin/product">Product Managment</a></li>
							
						</ul>
					</li>
					<li class="@if(Request::segment(2) == 'orders') active @endif">
						<a href="#"><i class="icon-box-add"></i> <span>Orders</span></a>
						<ul>
							<li class="@if(Request::segment(3) == 'printing_orders') active @endif"><a href="{{ url('/') }}/admin/orders/printing_orders">Printing Orders</a></li>
							<li class="@if(Request::segment(3) == 'design_orders') active @endif"><a href="{{ url('/') }}/admin/orders/design_orders">Design Orders</a></li>
							<li class="@if(Request::segment(3) == 'external_orders') active @endif"><a href="{{ url('/') }}/admin/orders/external_orders">External Orders</a></li>
							<li class="@if(Request::segment(3) == 'samplekit_orders') active @endif"><a href="{{ url('/') }}/admin/orders/samplekit_orders">Sample Kit Orders</a></li>
							<li class="@if(Request::segment(3) == 'evaluations') active @endif"><a href="{{ url('/') }}/admin/orders/evaluations">Evaluations</a></li>
							
						</ul>
					</li>
					<li  class="@if((Request::segment(2) == 'promo_codes') || (Request::segment(2) == 'invoices') || (Request::segment(2) == 'discounts') ) active @endif">
						<a href="#"><i class="icon-credit-card"></i> <span>Finance</span></a>
						<ul>
							<li class="@if(Request::segment(3) == 'invoices') active @endif"><a href="{{ url('/') }}/admin/invoices">Invoices</a></li>
							<li class="@if(Request::segment(3) == 'promo_codes') active @endif"><a href="{{ url('/') }}/admin/promo_codes">Promo Code</a></li>
							<li class="@if(Request::segment(3) == 'discounts') active @endif"><a href="{{ url('/') }}/admin/discounts">Discounts</a></li>
						...
						<ul>
							<li class="@if(Request::segment(3) == 'customers') active @endif"><a href="{{ url('/') }}/admin/reports/customers">Customers</a></li>
							<li class="@if(Request::segment(3) == 'agents') active @endif"><a href="{{ url('/') }}/admin/reports/agents">Agents</a></li>
							<li class="@if(Request::segment(3) == 'products') active @endif"><a href="{{ url('/') }}/admin/reports/products">Products</a></li>
							<li class="@if(Request::segment(3) == 'sales') active @endif"><a href="{{ url('/') }}/admin/reports/sales">Sales</a></li>
							<li class="@if(Request::segment(3) == 'orders') active @endif"><a href="{{ url('/') }}/admin/reports/orders">Orders</a></li>
							<li class="@if(Request::segment(3) == 'promo_code') active @endif"><a href="{{ url('/') }}/admin/reports/promo_code">Promo Code</a></li>
							<li class="@if(Request::segment(3) == 'discount') active @endif"><a href="{{ url('/') }}/admin/reports/discount">Discount</a></li>
							<li class="@if(Request::segment(3) == 'evaluation') active @endif"><a href="{{ url('/') }}/admin/reports/evaluation">Evaluation</a></li>
							<li class="@if(Request::segment(3) == 'analytics') active @endif"><a href="{{ url('/') }}/admin/reports/analytics">Website</a></li>
					...
					<li class="@if(Request::segment(2) == 'settings') active @endif">
						...
						<ul>
							<li class="@if(Request::segment(3) == 'customer_groups') active @endif"><a href="{{ url('/') }}/admin/settings/customer_groups">Customer Groups</a></li>
							<li class="@if(Request::segment(3) == 'countries') active @endif"><a href="{{ url('/') }}/admin/settings/countries">Countries</a></li>
							<li class="@if(Request::segment(3) == 'cities') active @endif"><a href="{{ url('/') }}/admin/settings/cities">Cities</a></li>
							<li class="@if(Request::segment(3) == 'delivery') active @endif"><a href="{{ url('/') }}/admin/settings/delivery">Delivery</a></li>
							<li class="@if(Request::segment(3) == 'pickup_points') active @endif"><a href="{{ url('/') }}/admin/settings/pickup_points">Pickup Points</a></li>
							<li class="@if(Request::segment(3) == 'vat') active @endif"><a href="{{ url('/') }}/admin/settings/vat">Vat</a></li>
						</ul>
					</li>
					<li class="@if(Request::segment(2) == 'content') active @endif">
						<a href="{{ url('/') }}/admin/content"><i class="icon-stack2"></i> <span>Content</span></a>
						<!-- <ul>
							<li class="@if(Request::segment(3) == 'customer_groups') active @endif"><a href="{{ url('/') }}/admin/settings/customer_groups">Customer Groups</a></li>
							<li class="@if(Request::segment(3) == 'countries') active @endif"><a href="{{ url('/') }}/admin/settings/countries">Countries</a></li>
							<li class="@if(Request::segment(3) == 'cities') active @endif"><a href="{{ url('/') }}/admin/settings/cities">Cities</a></li>
					...
					<!-- Forms -->
					<!-- Forms section commented by webwing -->
				<!-- 	<li class="navigation-header"><span>Forms</span> <i class="icon-menu" title="Forms"></i></li>
					...
					<!-- Appearance -->
					<!-- Appearance section is commented by webwing -->
					...
					<!-- Layout -->
					<!-- Layout section commented by webwing-->
					...
					<!-- Data visualization -->
					<!-- Data visualization section commented by webwing -->
					...
					<!-- Extensions -->
					<!-- Extensions section commented by webwing -->
				<!-- 	<li class="navigation-header"><span>Extensions</span> <i class="icon-menu" title="Extensions"></i></li>
					...
					<!-- Tables -->
					<!-- Tables section commented by webwing -->
					...
					<!-- Page kits -->
					<!-- Page kits section commented by webwing -->
