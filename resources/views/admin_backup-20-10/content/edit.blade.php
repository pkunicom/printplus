				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-body">
							...
							<form action="{{$module_url_path}}/update_content/{{ base64_encode($arr_data['id']) }}" id="frm_front_page" name="frm_front_page" class="form-horizontal cmxform" method="post" enctype="multipart/form-data">
							{{csrf_field()}}
								<fieldset class="content-group">
									<legend class="text-bold">Edit Content</legend>

									<div class="form-group">
										<label class="control-label col-lg-2">Page title</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" name="page_title" id="page_title" data-rule-required="true" value="{{ $arr_data['page_title'] ?? '' }}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control"  name="meta_title" id="meta_title" data-rule-required="true" value="{{ $arr_data['meta_title'] ?? '' }}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control"  name="meta_keyword" id="meta_keyword" data-rule-required="true" value="{{ $arr_data['meta_keyword'] ?? '' }}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea rows="5" cols="5" class="form-control"  name="meta_description" id="meta_description" data-rule-required="true">{{ $arr_data['meta_description'] ??'' }}</textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea rows="5" cols="5" class="form-control"  name="content" id="content" data-rule-required="true">{{ $arr_data['page_description'] ?? '' }} </textarea>
										</div>
									</div>
								</fieldset>
