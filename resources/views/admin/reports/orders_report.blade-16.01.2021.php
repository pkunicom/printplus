				...
				<div class="panel panel-flat" style="padding:30px;">
					<div class="row">
						...
						<form action="{{$module_url_path}}/get_orders" id="get_orders" method="post" enctype="multipart/form-data" >
							...
							<div class="col-lg-2">
								<button type="submit" id="proceed_get" class="btn btn-primary" style="top: 27px;left: 15px;">Get</button>
							</div>
						</form>
						<form action="{{$module_url_path}}/export_orders" id="export_orders" method="post" enctype="multipart/form-data" >
							...
							<div class="col-lg-6">
								...
								<button type="button" id="proceed_export_orders" onclick="return export_orders();" class="btn btn-primary" style="top: 27px;left: 691px;margin-left: 27.318;"><i class="fa fa-file-excel-o"></i> Export</button>
							</div>
						</form>
					...
					<div class="row" style="margin-top: 10px;">
						<div class="col-lg-3">
							<h3 style="text-align:center;">Top 5 Cities</h3>
							<table class="table">
								<thead>
									<tr>
										<th>#</th>
						...
						<div class="col-lg-3">
							<h3 style="text-align:center;">Top Delivery Option</h3>
							<table class="table">
								<thead>
									<tr>
										<th>#</th>
						...
						<div class="col-lg-3">
							<h3 style="text-align:center;">Top 5 Days</h3>
							<table class="table">
								<thead>
									<tr>
										<th>#</th>
						...
						<div class="col-lg-3">
							<h3 style="text-align:center;">Top 5 Hours</h3>
							<table class="table">
								<thead>
									<tr>
										<th>#</th>
