					...
					<div class="row">
						<div class="col-lg-3">
							<div class="panel total-count-block">
								<div class="panel-body">
									<h6 class="no-margin">@if($total_promo_code_count!=null){{$total_promo_code_count}} @else 00 @endif</h6>
						...
						<div class="col-lg-3">
							<div class="panel total-count-block dash-box-lecture">
								<div class="panel-body">
									<h6 class="no-margin">@if($active_promo_code_count!=null){{$active_promo_code_count}} @else 00 @endif</h6>
