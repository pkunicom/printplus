						...
						<div class="col-lg-3">
							<div class="panel total-count-block">
								<div class="panel-body">
									<h6 class="no-margin">@if($total_evaluation_count!=null){{$total_evaluation_count}} @else 00 @endif</h6>
