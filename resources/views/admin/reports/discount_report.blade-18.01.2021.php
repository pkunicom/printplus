						...
						<div class="col-lg-3">
							<div class="panel total-count-block">
								<div class="panel-body">
									...
									<div class="text-muted text-size-small">@if($total_discounts_count!=null){{$total_discounts_count}} @else 00 @endif</div>
						...
						<div class="col-lg-3">
							<div class="panel total-count-block dash-box-lecture">
								<div class="panel-body">
									...
									<div class="text-muted text-size-small">@if($active_discounts_count!=null){{$active_discounts_count}} @else 00 @endif</div>
									<div class="clearfix"></div>
								</div>
								<div id="server-load"></div>
							</div>
