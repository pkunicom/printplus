				...
				<div class="content">
					...
					<div class="row">
						<div class="col-lg-3">
							<div class="panel total-count-block">
								<div class="panel-body">
									<h6 class="no-margin">@if($total_customer_count!=null){{$total_customer_count}} @else 00 @endif</h6>
						...
						<div class="col-lg-3">
							<div class="panel total-count-block dash-box-lecture">
								<div class="panel-body">
									<h6 class="no-margin">@if($active_customer_count!=null){{$active_customer_count}} @else 00 @endif</h6>
					...
					<div class="row">
						...
						<div class="col-lg-5">
							<div class="panel panel-flat panel-graph">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Lorem Ipsum</h6>
								</div>
								<div class="customer-label-txt-section">
									<div class="customer-label-section">
										<h6 class="panel-title text-semibold">Consumer</h6>
									</div>
									<div class="customer-txt-section">
								...
								<div class="customer-label-txt-section">
									<div class="customer-label-section">
										<h6 class="panel-title text-semibold">SME</h6>
									</div>
									<div class="customer-txt-section">
										5
									</div>
								...
								<div class="customer-label-txt-section">
									<div class="customer-label-section">
										<h6 class="panel-title text-semibold">Enterprise</h6>
									</div>
									<div class="customer-txt-section">
										8
									</div>
								...
								<div class="customer-label-txt-section">
									<div class="customer-label-section">
										<h6 class="panel-title text-semibold">Governement</h6>
									</div>
									<div class="customer-txt-section">
										20
									</div>
								...
								<div class="customer-label-txt-section">
									<div class="customer-label-section">
										<h6 class="panel-title text-semibold">Reseller</h6>
									</div>
									<div class="customer-txt-section">
										9
									</div>
