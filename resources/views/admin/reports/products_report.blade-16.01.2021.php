			...
			<div class="content-wrapper">
				...
				<div class="content">
						...
						<div class="col-lg-3">
							<div class="panel total-count-block">
								<div class="panel-body">
									...
									<div class="text-muted text-size-small">{{$category_count}}</div>
						...
						<div class="col-lg-3">
							<div class="panel total-count-block">
								<div class="panel-body">
									...
									<div class="text-muted text-size-small">{{$sub_category_count}}</div>
									<div class="clearfix"></div>
								</div>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="panel total-count-block">
								<div class="panel-body">
									...
									<div class="text-muted text-size-small">{{$products_count}}</div>
									<div class="clearfix"></div>
								</div>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="panel total-count-block">
								<div class="panel-body">
									...
									<div class="text-muted text-size-small">{{$accessory_count}}</div>
									<div class="clearfix"></div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="add-user-btn-main">
							<a class="btn btn-primary"  id="open_add_product_modal" href="{{ $module_url_path}}/export_accessory" style="margin-bottom: 10px;"><i class="fa fa-file-excel-o"></i> Export</a>
							<!-- <a class="btn btn-primary"  id="open_add_product_modal" href="#"><i class="fa fa-file-excel-o"></i> Export</a> -->
