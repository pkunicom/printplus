				...
				<div class="content">
					...
					<div class="row">
						<div class="col-lg-2">
							<div class="panel total-count-block">
								<!-- Old block commented as per client -->
								<!-- <div class="panel-body">
									<div class="dash-box-head">Total <br>Customers</div>
									<h6 class="no-margin">Total Customers</h6>
									<div class="text-muted text-size-small">101,123</div>
									<div class="clearfix"></div>
								</div> -->
								<div class="panel-body">
									<h6 class="no-margin">{{isset($total_customer) ? $total_customer : ''}}</h6>
									<div class="dash-box-head">Total <br>Customers</div>								
						...
						<div class="col-lg-2">
							<div class="panel total-count-block dash-box-lecture">
								<div class="panel-body">
									<h6 class="no-margin">{{isset($total_today_user) ? $total_today_user : ''}}</h6>
									<div class="dash-box-head">Today  <br>Customers</div>									
									<div class="dash-box-icon">
						...
						<div class="col-lg-2">
							<div class="panel total-count-block dash-box-lectures">
								<div class="panel-body">
									<h6 class="no-margin">{{isset($total_order) ? $total_order : ''}}</h6>
						...
						<div class="col-lg-2">
							<div class="panel total-count-block dash-box-questions">
								<div class="panel-body">
									<h6 class="no-margin">{{isset($total_today_order) ? $total_today_order : ''}}</h6>
						...
						<div class="col-lg-2">
							<div class="panel total-count-block dash-box-news-feeds">
								<div class="panel-body">
									<h6 class="no-margin">{{isset($total_pending_order) ? $total_pending_order : ''}}</h6>
						...
						<div class="col-lg-2">
							<div class="panel total-count-block dash-box-notification">
								<div class="panel-body">
									...
									<div class="dash-box-head">Today <br> Sales</div>
									<div class="dash-box-icon">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							...
							<div class="panel panel-flat panel-graph">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">Top 10 customers</h6>
								</div>
								<div class="panel-body">
						...
						<div class="col-lg-4">
							<div class="panel panel-flat panel-graph">
								<div class="panel-heading">
									<h6 class="panel-title text-semibold">This Month Sales</h6>
								</div>
								<div class="panel-body">
									<div class="chart-container text-center">
