								...
								<div class="panel panel-flat">
									<div class="page-head-section-main">
										<div class="page-head-txt">
											Manage Product Option <span></span>
										</div>
												...
												<div class="fixed_quantity_section">
													<div class="radio-btns">  
														<div class="radio-btn">
															...
															<input type="text" data-rule-required="true" class="form-control validate_fixed" name="fixed_quantity" placeholder="Quantity" style="width: auto;display: inline-block;vertical-align: middle;" />
															<!-- <div class="check"></div> -->
												...
												<div class="variable_quantity_section">
													<div class="radio-btns">  
														<div class="radio-btn">
															...
															<input type="text" class="form-control validate_variable" name="variable_minimum" data-rule-number="true" placeholder="Minimum" style="width: 20%;display: inline-block;vertical-align: middle;" />
															<input type="text" class="form-control validate_variable" name="variable_maximum" data-rule-number="true" placeholder="Maximum" style="width: 20%;display: inline-block;vertical-align: middle;" />
															<input type="text" class="form-control validate_variable" name="variable_discount" data-rule-number="true" placeholder="Discount" style="width: 20%;display: inline-block;vertical-align: middle;" />
															<!-- <div class="check"></div> -->
