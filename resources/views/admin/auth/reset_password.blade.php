    ...
    <div class="page-container admin-login-bx">
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    <!-- Password recovery -->
                   <form action="{{url('/')}}/admin/save_password/{{base64_encode($obj_data['id'])}}" method="POST" name="reset_password" id="reset_password">
                            {{csrf_field()}}
                        ...
                        @include('admin.layout._operation_status')
                            ...
                            <div class="form-group has-feedback">
                                <input type="password" name="cpassword" id="cpassword" class="form-control" placeholder="Confirm Password" data-rule-equalto = "#password"  data-rule-required="true" minlength="8">
                                <div class="form-control-feedback">
                                    <i class="icon-mail5 text-muted"></i>
                                </div>
                            </div>
