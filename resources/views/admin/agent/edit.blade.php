						...
						<!-- <div class="col-md-6"> -->
							<div class="">
								...
								<!-- <div class="panel-heading">
									...
									<div class="tabbable agent-managment-tabs-main">
											...
											<div class="tab-pane active" id="overview">
												<div class="tab-margin-remve">
													<div class="row">
														...
														<div class="col-lg-6">
															<div class="panel agent-edit-main agent-edit-without-img">	
																<div class="agent-information-section">																
																	<div class="agent-information-main">
																		<div class="agent-information-head">
																			Contact
													...
													<div class="col-sm-6 col-md-6 col-lg-6">
														<div class="form-group file-uploadSection-main">												
															...
															@if(isset($arr_data['get_documents_details']['company_cr']) && !empty($arr_data['get_documents_details']['company_cr']) )
																...
																<span class="view-btn-upload" style="display:inline-block;"><a href="{{ $agent_documents_public_img_path.'/'.$arr_data['get_documents_details']['company_cr']  ?? ''}}" target="_blank"><i class="fal fa-paperclip"></i></a> </span>	
															@else
													...
													<div class="col-sm-6 col-md-6 col-lg-6">
														<div class="form-group file-uploadSection-main">												
															...
															@if(isset($arr_data['get_documents_details']['license']) && !empty($arr_data['get_documents_details']['license']) )
																...
																<span class="view-btn-upload" style="display:inline-block;"><a href="{{ $agent_documents_public_img_path.'/'.$arr_data['get_documents_details']['license']  ?? ''}}" target="_blank"><i class="fal fa-paperclip"></i></a> </span>
															@else
													...
													<div class="col-sm-6 col-md-6 col-lg-6">
														<div class="form-group file-uploadSection-main">												
															...
															@if(isset($arr_data['get_documents_details']['vat_reg']) && !empty($arr_data['get_documents_details']['vat_reg']) )
																...
																<span class="view-btn-upload" style="display:inline-block;"><a href="{{ $agent_documents_public_img_path.'/'.$arr_data['get_documents_details']['vat_reg']  ?? ''}}" target="_blank"><i class="fal fa-paperclip"></i></a> </span>
															@else
