				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<!-- <div class="add-user-btn-main">
							...
							<a class="btn btn-primary"  id="open_add_delivery_modal" href="javascript:void(0)">Add Delivery</a>
						...
						<div id="add_modal_form_vertical" class="modal fade addUserModalMain">
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<form action="{{ $module_url_path }}/add_delivery" id="add_delivery" method="post" enctype="multipart/form-data" >
											...
											<div class="row">
												...
												<div class="col-sm-6 col-md-6 col-lg-12">
													...
													<div class="form-group">												
														...
														<input type="text" data-rule-required="true"  data-rule-number="true" name="add_city_id" id="add_city_id" class="form-control" >
												...
												<div class="col-sm-6 col-md-6 col-lg-6">
													...
													<div class="form-group ">												
														...
														<input type="text" data-rule-required="true" name="add_city_name" id="add_city_name" class="form-control  " >
												...
												<div class="col-sm-6 col-md-6 col-lg-12">
													...
													<div class="form-group">												
														...
														<select class="form-control change_category" name="add_category" id="add_category"></select>
												...
												<div class="col-sm-6 col-md-6 col-lg-12">
													...
													<div class="form-group">												
														...
														<select class="form-control change_sub_category" name="add_sub_category" id="add_sub_category"></select>
												...
												<div class="col-sm-6 col-md-6 col-lg-12">
													...
													<div class="form-group">												
														...
														<select class="form-control" name="add_product" id="add_product"></select>
												...
												<div class="col-sm-6 col-md-6 col-lg-12">
													...
													<div class="form-group">												
														...
														<select class="form-control" name="add_city" id="add_city"></select>
													...
													<div class="form-group">		
														...
														<div class="checkbox">
															...
															<label>
																...
																<input type="checkbox"  id="delivery_service" name="delivery_service">
													...
													<div class="form-group">		
														...
														<div class="checkbox">
															...
															<label>
																...
																<input type="checkbox" id="limit_customer" name="limit_customer">

																Limit this discount for first order for new customers
						...
						<div id="edit_modal_form_vertical" class="modal fade addUserModalMain">
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<form action="{{ $module_url_path }}/edit_delivery" id="edit_delivery_form" method="post" enctype="multipart/form-data" >
											...
											<div class="row">
												...
												<div class="col-sm-6 col-md-6 col-lg-12">
													...
													<div class="form-group">												
														...
														<input type="text" data-rule-required="true"  data-rule-number="true" name="edit_city_id" id="edit_city_id" class="form-control" readonly="true">
												...
												<div class="col-sm-6 col-md-6 col-lg-12">
													...
													<div class="form-group ">												
														...
														<input type="text" data-rule-required="true" name="edit_city_name" id="edit_city_name" class="form-control  "  readonly="true">
												...
												<div class="col-sm-6 col-md-6 col-lg-12">
													...
													<div class="form-group">												
														...
														<input type="text" data-rule-required="true" name="edit_country_name" id="edit_country_name"  class="form-control "  readonly="true">
													...
													<div class="form-group">		
														...
														<div class="checkbox">
															...
															<label>
																...
																<input type="checkbox"  id="edit_pickup_point" name="edit_pickup_point">
													...
													<div class="form-group">		
														...
														<div class="checkbox">
															...
															<label>
																...
																<input type="checkbox" id="edit_delivery" name="edit_delivery">
														...
														<input type="number" data-rule-required="true" data-rule-number="true" name="edit_delivery_day" id="edit_delivery_day"  class="form-control " placeholder="Enter number of days">
													...
													<div class="form-group">		
														...
														<div class="checkbox">
															...
															<label>
																...
																<input type="checkbox" id="edit_express_delivery" name="edit_express_delivery">

																Express Delivery (SAR)

															</label>

														</div>

														<input type="text" data-rule-required="true" name="edit_express_delivery_price" id="edit_express_delivery_price"  class="form-control " >
...
$(function() {
    ...
    var table = $('.datatable-column-search-inputs').DataTable({
        ...
        columns: [
            ...
            {data : 'city_id',"orderable":true,"searchable":true,name:'city_id'},

            {data : 'city',"orderable":true,"searchable":true,name:'city'},

            {data : 'country',"orderable":false,"searchable":true,name:'country'},

            {data : 'standard_delivery',"orderable":false,"searchable":true,name:'standard_delivery'},

            {data : 'express_delivery',"orderable":false,"searchable":false,name:'express_delivery'},

            {data : 'pickup_point',"orderable":false,"searchable":false,name:'pickup_point'},
...
$(document).ready(function(){
	...
	$("#add_delivery").validate();

    $("#edit_delivery_day").hide();



 

	$('body').on('change','#edit_delivery',function(){

		var check = $(this). prop("checked");

		if(check==true){

			$("#edit_delivery_day").show();
	...
	$('body').on('click','#open_edit_modal_form_vertical',function(){
		...
		$.ajax({
            ...
            url : '{{ $module_url_path}}/get_data/'+id,
            ...
            success:function(resp){
                ...
                if(resp.status=='success'){
                    ...
                    $('#edit_city_name').val(resp.data.get_city_details.city_english_name);

                    $('#edit_city_id').val(resp.data.get_city_details.city_id);

                    $('#edit_country_name').val(resp.data.get_city_details.get_country.country_english_name);

                    $('#edit_express_delivery_price').val(resp.data.express_delivery_cost);

                    $('#edit_delivery_day').val(resp.data.standard_delivery_days);

                    if(resp.data.pickup_point=='yes'){



                  		$("#edit_pickup_point"). prop("checked", true);

                    }else{

                  		$("#edit_pickup_point"). prop("checked", false);
                    ...
                    if(resp.data.standard_delivery=='yes'){



                  		$("#edit_delivery"). prop("checked", true);
                    ...
                    if(resp.data.express_delivery=='yes'){



                  		$("#edit_express_delivery"). prop("checked", true);

                    }else{

                  		$("#edit_express_delivery"). prop("checked", false);
