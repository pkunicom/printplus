...
<div class="navbar navbar-inverse ">
	<div class="navbar-header">
		<!-- <a class="navbar-brand" href="index.html"><img src="{{ asset('assets/admin') }}/assets/images/logo_light.png" alt=""></a> -->
		&nbsp;
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown language-switch">
				...
				<ul class="dropdown-menu">
					<li><a class="deutsch"><img src="{{ asset('assets/admin') }}/assets/images/flags/uae.png" alt="">Arabic</a></li>
					{{--Commented by webwing--}}
					{{-- <!-- <li><a class="ukrainian"><img src="{{ asset('assets/admin') }}/assets/images/flags/ua.png" alt=""> Українська</a></li>
					<li><a class="english"><img src="{{ asset('assets/admin') }}/assets/images/flags/gb.png" alt=""> English</a></li>
					<li><a class="espana"><img src="{{ asset('assets/admin') }}/assets/images/flags/es.png" alt=""> España</a></li>
					<li><a class="russian"><img src="{{ asset('assets/admin') }}/assets/images/flags/ru.png" alt=""> Русский</a></li> --> --}}
				</ul>
			</li>
			...
			{{-- <!-- 		<li><a href="#"><i class="icon-user-plus"></i> My profile</a></li>
					...
					<li><a href="{{ url('/') }}/agent/logout"><i class="icon-switch2"></i> Logout</a></li>
				</ul>
			</li>
		</ul>
	</div>
