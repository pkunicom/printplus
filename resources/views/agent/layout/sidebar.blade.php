...
<div class="sidebar sidebar-main">
	<div class="logo-section">
		<a class="navbar-brand sidebar-login-logo" href="index.html"><img src="{{ asset('assets/admin') }}/assets/images/logo_light.png" alt=""></a>
	</div>
		...
		<div class="sidebar-category sidebar-category-visible">
			<div class="category-content no-padding">
				<ul class="navigation navigation-main navigation-accordion">
					...
					<li class="@if(Request::segment(2) == 'dashboard') active @endif"><a href="{{ url('/') }}/agent/dashboard"><i class="icon-home4"></i> <span>Dashboard</span></a></li>
					<li class="@if((Request::segment(2) == 'user')) active @endif">
						<a href="{{ url('/') }}/agent/user"><i class="icon-user"></i> <span>User</span></a>
					...
					<li  class="@if(Request::segment(2) == 'products') active @endif">
						<a href="{{ url('/') }}/agent/products"><i class="icon-copy"></i> <span>Products</span></a>
						{{--Below section is commented by webwing--}} 
						{{-- <ul>
					...
					<li class="@if(Request::segment(2) == 'orders') active @endif">
						<a href="{{ url('/') }}/agent/orders"><i class="icon-box-add"></i> <span>Orders</span></a>
						{{--Below section is commented by webwing--}} 
						{{--<ul>
					...
					<li  class="@if((Request::segment(2) == 'invoices') ) active @endif">
						<a href="{{ url('/') }}/agent/invoices"><i class="icon-credit-card"></i> <span>Finance</span></a>
						{{--Below section is commented by webwing--}} 
						{{--<ul>
