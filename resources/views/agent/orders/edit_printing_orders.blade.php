								...
								<div class="panel-body">
									<div class="tabbable agent-managment-tabs-main" id="tabload">
										<ul class="nav nav-tabs nav-tabs-solid nav-tabs-component nav-justified">
											...
											<li><a href="#evaluation" data-toggle="tab" id="view_evaluation">Evaluation</a></li>											
										</ul>
									...
									<!-- 			<div class="row">
														...
														<div class="panel agent-edit-main edit-order-col">
															...
															<div class="agent-information-section">
																...
																<div class="agent-information-main">
																	...
																	<div class="agent-information-content">
																		<span>:</span> <a href="javascript:void(0)">4575777775</a>
																	</div>																	
																</div>	
																<div class="agent-information-main">
																	<div class="agent-information-head">
										...
										<!-- 	<div class="tab-pane" id="finance_details">
													...
													<div id="modal_form_vertical" class="modal fade addUserModalMain">
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<form action="{{ url('/') }}/agent/orders/store_printing_order_note" id="add_note" method="post" enctype="multipart/form-data" >
																{{csrf_field()}}
											...
											<div class="tab-pane" id="evaluation">
												...
												<table class="table datatable-column-search-inputs" id="datatable_evaluation">
													<thead>
														<tr>
															<th>Product</th>
															<th>Option</th>
...
<script>
	$(document).ready(function(){
		...
		/*TAB 1 (Order details) : Author (Harsh Chauhan)*/
		var order_id  = "{{ $arr_data['id'] ??''}}";
		alert(order_id);
		var sorder_id = btoa(order_id);
		$(function() {
		    ...
		    var table = $('#datatable_customer_orders').DataTable({
			    ...
			    "bLengthChange": true,
		        ajax: {
		            url: "{{ $module_url_path}}/load_orderproducts_data/"+sorder_id,
		            data: function(d) {
		        ...
		        columns: [
		            ...
		            {data : 'pack',"orderable":false,"searchable":true,name:'pack'},
		            {data : 'unit_price',"orderable":false,"searchable":false,name:'unit_price'},
		            {data : 'quantity',"orderable":false,"searchable":false,name:'quantity'},
		            {data : 'total_price',"orderable":false,"searchable":false,name:'total_price'},
		        ],
		        "aoColumnDefs": [
		...
		/*TAB 2 ORder COmpensation AUthor : HArsh Chauhan*/
		...
		// Add Compensation Author : (Harsh Chauhan)
		...
		/*TAB 3 Status History Author : (HArsh Chauhan)*/
		...
		/*TAB 4 Extra Notes Authior : (HArsh Chauhan)*/
		...
		/*TAB 5 Evaluation Listing Author :(Harsh Chauhan)*/
		$('body').on('click','#view_evaluation',function(){
			var order_id  = "{{ $arr_data['id'] ?? '' }}";
			$(function() {
			    ...
			    var table = $('#datatable_evaluation').DataTable({
			        "bStateSave": true,
			        "bSearchable":true,
			        "processing": true,
				    "serverSide": false,
				    ...
				    "bLengthChange": true,
			        ajax: {
			            url: "{{ $module_url_path}}/load_evaluation_data/"+btoa(order_id),
			            data: function(d) {
			                d['column_filter[invoice_id]'] 				= $("input[name='invoice_id']").val()
			                d['column_filter[invoice_amount]']   		= $("input[name='invoice_amount']").val()
			            }
			        ...
			        columns: [
			            ...
			            {data : 'comment',"orderable":false,"searchable":true,name:'comment'}
